			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="AdminLogin" method="post" id="contactForm" novalidate="novalidate">
							...
							<div class="col-md-12 form-group">
								<button onclick="formkontrol()" class="primary-btn">Giriş Yap</button>
