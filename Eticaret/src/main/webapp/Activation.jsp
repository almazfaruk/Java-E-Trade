			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3>Aktivasyon</h3>
						<form class="row login_form" action="Activation" method="post" id="contactForm" novalidate="novalidate">
							<div class="col-md-12 form-group">
								<label>Lütfen Emailinize gelen doğrulama kodunu giriniz</label>
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="Password" name="Password" placeholder="Aktivasyon Kodu" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'">
							</div>

							<div class="col-md-12 form-group">
								<button type="submit"   class="primary-btn">Kodu Doğrula</button>
							</div>
						</form>
					</div>
				</div>
            ...
            <script type="text/javascript">
               function successalert() {                                    
                    ...
                    swal.fire({ title: "Başarılı!",
                    	 text: "Kaydınız tamamlandı giriş ekranına yönlendiriliyorsunuz!",
...
if((int)request.getAttribute("State")==1)
{
	...
	<script>
	$(document).ready(function(){
		erroralert("Aktivasyon Kodu Hatalı girildi!");
		});
	</script>
	<%
}
