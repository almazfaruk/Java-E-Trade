...
<%@page import="Usercontroller.Users"%>
    <% 
    if (!Objects.isNull(request.getParameter("IsTokenId"))) 
    {
        int id =Integer.parseInt(request.getParameter("IsTokenId"));
        request.setAttribute("d", id);
   }
   else
   {
					...
					<div class="login_form_inner">
						...
						<input type="hidden" name="UserId" value="${d}" />
							<div class="col-md-12 form-group">
								<input type="password" class="form-control" id="Password" name="Password" placeholder="Şifre1" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'">
							</div>
							<div class="col-md-12 form-group">
								<input type="password" class="form-control" id="Password2" name="Password2" placeholder="Şifre2" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'">
							</div>

							<div class="col-md-12 form-group">
								<a  onclick="formkontrol()" class="primary-btn">Şifreyi Yenile</a>
							</div>
						</form>
					</div>
				</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
               ...
               function successalert() {                                    
                    ...
                    swal.fire({ title: "Başarılı!",
                    	 ...
                    	 type: "success"}).then(okay => {
                    	   if (okay) {
                    	    window.location.href = "http://localhost:4088/Eticaret/Login.jsp";
                    	  }
                    	});
                    };
            </script>
	...
	<script type="text/javascript">
        ...
        function formkontrol(){
            ...
            if (Pw!=Pw2)
            Error.push("<p style='width:100%'>İlk şifreyle ikinci aynı olmalıdır!</p>");
