			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="ForgotPw" method="post" id="contactForm" novalidate="novalidate">
							...
							<div class="col-md-12 form-group">
								<button onclick="formkontrol()" class="primary-btn">Gönder</button>
							</div>
						</form>
					</div>
				</div>
...
{
if((int)request.getAttribute("State")==0)
{
	%>
	<script>
